...
function EntryStampRequired(props) {
        ...
        <div id="commsOutput">
            ...
            <div className="comms-email-content">
                <p ref={emailContent}>
                    ...
                    <br />
                    Please provide a clear copy of your Visa type and expiry and your Entry Stamp/ E-Ticket in a response to this email.<br />
                    <br />
...
export default EntryStampRequired