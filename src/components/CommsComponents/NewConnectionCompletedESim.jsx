...
function NewConnectionCompletedESim (props) {
    ...
    useEffect(() => {
        if(props.customerName === ''||props.agentName === ''||props.dotNumber === ''||props.dueDate === ''||plan === ''||number === ''){
            setFormFilled(true);
        }
        else{
            setFormFilled(false);
        }
    }, [props.customerName,props.agentName,props.dotNumber,props.dueDate,plan,number])
    ...
    return(
        <div id="commsOutput">
            ...
            <div className="comms-mobile-content">
                <p ref={mobileContent}>
                Kia ora {props.customerName}, your new One NZ {plan} is all set up and ready to use. Your new number is {number}. 
            ...
            <div className="comms-email-content">
                <p ref={emailContent}>
                    ...
                    <br />
                    Your new One NZ {plan} is all set up and ready to use. Your new number is {number}. <br />
                    <br />
