...
function PassportAndVisaRequired(props) {
        ...
        <div id="commsOutput">
            ...
            <div className="comms-mobile-content">
                <p ref={mobileContent}>
                    ...
                    we need to see a copy of your Passport and Valid Visa.
            ...
            <div className="comms-email-content">
                <p ref={emailContent}>
                    ...
                    <br />
                    Please provide a clear copy of your Passport and Valid Visa in a response to this email.<br />
                    <br />
...
export default PassportAndVisaRequired