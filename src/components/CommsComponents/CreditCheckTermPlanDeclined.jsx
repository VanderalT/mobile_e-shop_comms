...
function CreditCheckTermPlanDeclined (props) {
    ...
    return(
        <div id="commsOutput">
            ...
            <div className="comms-mobile-content">
                ...
                it's {props.agentName} here from One NZ. 
                ...
                If you'd like more information about your personal credit history, you can contact Illion on 0800 733 807. 
            ...
            <div className="comms-email-content">
                <p ref={emailContent}>
                    ...
                    <br /> 
                    Unfortunately you haven't met the credit criteria for the plan you chose so we are unable to complete the order {props.dotNumber}. <br />
                    <br /> 
                    If you'd like more information about your personal credit history, you can contact Illion on 0800 733 807. <br />
                    <br /> 
                    Thanks <br />
...
export default CreditCheckTermPlanDeclined